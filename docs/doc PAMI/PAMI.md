...
Les PAMI (*Petit Actionneur Mobile Indépendant*) ont pour objectif, selon le règlement de la Coupe de France de robotique 2026, d'aller dans **certaines zones en fin de match afin de sécuriser des garde-manger** (*zones délimitées dans lesquelles le robot principal a pour objectif de disposer des caisses de la couleur assignée à l'équipe*).
...
![Photo des PAMI en match](/docs/images/PAMI_Bastian.png)
